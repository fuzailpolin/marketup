      ...
      <header className={'shadow bg-white z-50 border-b-2 border-gray-300 sticky -top-0 -left-0'}>
        <div className="grid grid-cols-4">
          <div className={'pl-2 md:pl-5 flex items-center cursor-pointer'}>
            ...
            <Link href={'/'}>
              <p className={'text-primary font-typoSlab text-xl md:text-2xl z-10'}>
                Marketup<span className={'text-secondary'}>group</span>
              </p>
            </Link>
          </div>
          <div className="col-span-3 flex items-center justify-end font-poppins">
            <nav>
              ...
              <FaAlignRight onClick={() => setOpen(!open)}
                            className={'text-gray-600 inline-block lg:hidden mr-5 cursor-pointer'} size={24}/>
              <div
                ...
                <div className={'pl-4 flex items-center cursor-pointer'}>
                  ...
                  <Link href={'/'}>
                    <p className={'text-primary font-typoSlab text-xl md:text-2xl'}>
                      Marketup<span className={'text-secondary'}>group</span>
                    </p>
                  </Link>
                </div>
