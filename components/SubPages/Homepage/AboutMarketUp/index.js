        ...
        <div  className={'bg-black bg-contain md:bg-cover'} style={{backgroundImage: "url('/Images/wire_4.gif')", backgroundPosition: 'top left',  backgroundRepeat: 'no-repeat'}}>
            <div className={'container mx-auto pt-20 bg-no-repeat bg-cover bg-black bg-opacity-70'} id={'about'}>
                ...
                <p className={'text-gray-100 px-5 pb-3  pt-5 md:pt-10 font-poppins md:px-28 md:mx-12'}>A digital
                    A digital marketing agency revolving around the understanding of local psychology, beliefs, and culture. Just like a crow, we symbolize transformation and change. We are everywhere and we understand your need to up your market through our expertise.</p>
                <p className={'text-gray-100 px-5 pb-3  pt-3 md:pt-5 font-poppins md:px-28 md:mx-12'}>
                ...
                <p className={'text-gray-100 px-5 pb-3  pt-5 md:pt-10 font-poppins md:px-24'}>
