        ...
        <div className={"col-span-12 md:col-span-6 pb-2 md:ml-auto md:mr-0"}>
          <div className={'grid grid-cols-12'}>
            <div className={'col-span-6 '}>
              <div className="leading-none flex md:pr-2 flex-col md:justify-center ">
                <div className="mb-2 text-xs md:text-sm text-gray-400 font-semibold ">
                  Deadline
                </div>
                <div
                ...
                >
                  <div className="font-semiboldtext-gray-100 text-xs md:text-sm">
                    {new Date(deadLine?.lastDate).toDateString()}
                  </div>
